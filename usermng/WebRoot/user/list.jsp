...
<script type="text/javascript">
	function addUser() {
		window.location.href = "http://127.0.0.1:8080/usermng/user_doAdd.action";
		//window.document.URL = "localhost:8080/usermng/user_doAdd.action";
...
<body>
	<br>
	<s:form action="user_conditionsQuery" namespace="/" theme="simple">
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									学历：</td>
								<td class="ta_01" bgColor="#ffffff">
									<s:select list="{'博士','硕士','硕士','研究生','本科','专科','高中'}" name="education" headerKey="" headerValue="--选择学历--"></s:select>
								</td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									是否上传简历</td>
								<td class="ta_01" bgColor="#ffffff">
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3"><strong>用
							户 列 表</strong></TD>
				</tr>
				<tr>
							...
							<s:iterator value="top">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="18%"><s:property value="loginname" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%"><s:property value="username" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%"><s:property value="gender" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="23%"><s:property value="cellphone" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"><s:property
											value="education" /></td>
									<td align="center" style="HEIGHT: 22px">
										<s:a action="user_doEdit" namespace="/" >
											<s:param name="uid" value="uid"></s:param>
											<img src="<c:url value='/images/i_edit.gif'/>" border="0"style="CURSOR: hand">
										</s:a>
									</td>
									<td align="center" style="HEIGHT: 22px">
										<s:a action="user_doView" namespace="/" >
												<s:param name="uid" value="uid"></s:param>
												<img src="<c:url value='/images/button_view.gif'/>" border="0"style="CURSOR: hand">
										</s:a>
									</td>
									<td align="center" style="HEIGHT: 22px">
										<s:a action="user_del" namespace="/" onclick="return window.confirm('你确定删除，删错了别怪我没提醒你！')">
												<s:param name="uid" value="uid"></s:param>
